...
// it is to noise. 
#define APRS_COMMENT    "UBC Rocket"
...
// For Arduino Mega, use pin 9 or 10.

=======
// PWM, so the only two options are 9 and 10 [For UNO: pins 3 and 11].
// [For UNO: Pin 11 doubles as MOSI, so I suggest using pin 3 for PWM and leave 11 free
// in case you ever want to interface with an SPI device.]
>>>>>>> Stashed changes
#define AUDIO_PIN       9
...
#define MEASUREMENTS_PER_PERIOD 4
